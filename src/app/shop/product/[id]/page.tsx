  ...
  return (
    <div className="space-y-12 animate-in slide-in-from-bottom-8 duration-1000">
      <div className="flex items-center justify-between">
        <Button 
          variant="ghost" 
          className="text-primary hover:text-rose-700 px-0 h-12 rounded-full hover:bg-transparent group transition-all duration-300 transform hover:scale-105" 
          onClick={() => router.back()}
        >
          <div className="flex items-center gap-3">
            <ArrowLeft className="h-6 w-6 transition-transform group-hover:-translate-x-2 duration-300" /> 
            <span className="text-base md:text-xl font-black uppercase tracking-[0.15em] font-headline relative">
              Back to Collection
            ...
            <div className="relative flex-1 w-full rounded-[1.5rem] overflow-hidden group">
              ...
              <div className="absolute bottom-6 right-6 z-20">
                <div className="bg-stone-900/60 backdrop-blur-md border border-white/20 rounded-full px-5 py-2 shadow-2xl">
                  <p className={cn("text-[10px] font-black uppercase tracking-[0.4em]", isMainImagePrimary ? "text-white" : "text-yellow-400")}>
                    {isMainImagePrimary ? "PRIMARY PRODUCT IMAGE" : "OTHER VIEW"}
                  </p>
                </div>
              </div>
                    ...
                    >
                       ...
                       <div className="absolute bottom-2 left-2 z-10">
                          <div className="bg-stone-900/60 backdrop-blur-md border border-white/20 rounded-full px-2 py-0.5 shadow-lg">
                            <p className={cn("text-[6px] font-black uppercase tracking-widest whitespace-nowrap", isThisThumbnailPrimary ? "text-white" : "text-yellow-400")}>
                              {isThisThumbnailPrimary ? "PRIMARY PRODUCT IMAGE" : "OTHER VIEW"}
                            </p>
                          </div>
                       </div>
                    </button>
