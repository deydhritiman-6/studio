...
export default function ShopLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50 font-body">
      <header 
        className={cn(
          "sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur-xl px-4 md:px-6 flex items-center animate-in fade-in duration-1000 overflow-hidden shadow-sm transition-none",
      ...
      >
        ...
        <div className={cn(
          "flex w-full items-center justify-between gap-2 relative z-10 transition-none",
          ...
          <div className="flex-shrink-0">
            <Link href="/shop" className="hover:scale-105 block">
