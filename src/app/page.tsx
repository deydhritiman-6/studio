    ...
    <div className="min-h-screen font-body selection:bg-primary/20 relative overflow-x-hidden">
      ...
      <div className="w-full py-1.5 md:py-2.5 text-center border-b border-stone-200/40 overflow-hidden relative">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h2 className="text-[5.5vw] sm:text-4xl md:text-6xl lg:text-7xl font-bold font-headline tracking-[0.12em] leading-tight
      ...
      <main className="relative z-10">
        <section className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden py-24 px-6">
          ...
          <div className="hidden lg:block absolute right-12 top-[32%] -translate-y-1/2 z-30">
            <OccasionCard />
          </div>
        ...
        <section className="py-32 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              { icon: CheckCircle, title: "Pure Ingredients", desc: "No artificial preservatives. Just raw, vibrant flavor." },
            ].map((feat, i) => (
