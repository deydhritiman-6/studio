...
export default function LandingPage() {
  return (
    <div className="min-h-screen font-body selection:bg-primary/20 relative overflow-x-hidden">
      ...
      {/* Larger Tilted Logo below the header - Artisan Stamp Style - Shifted Extreme Left */}
      <div className="relative w-full">
        <div className="absolute top-28 -left-16 md:-left-24 z-20 pointer-events-none transform -rotate-12">
