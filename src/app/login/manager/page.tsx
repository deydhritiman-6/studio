    ...
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <Card className="w-full max-w-sm shadow-2xl border-border rounded-[2rem]">
        <CardHeader className="text-center space-y-4 pt-10 relative">
          ...
          <CardTitle className="font-headline text-2xl tracking-tight leading-tight">Store Manager</CardTitle>
          <CardDescription className="text-muted-foreground font-light italic">Operations & Inventory Control</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input value="manager@roseberry.com" readOnly className="h-12 rounded-xl bg-muted/50" />
              </div>
              <div className="space-y-1.5">
            ...
            <Button type="submit" className="w-full h-14 text-lg font-bold rounded-2xl shadow-xl shadow-accent/20 bg-accent text-accent-foreground hover:bg-accent/90" disabled={isLoading}>
